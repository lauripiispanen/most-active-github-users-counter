...
var PRESETS = map[string]PresetLocations{
	...
	"dominican republic": PresetLocations{"dominican%2Brepublic", "republica%2Bdominicana", "santo%2Bdomingo", "la%2Bvega", "macoris"},
	...
	"uae":                PresetLocations{"uae", "emirates", "dubai", "abu%2Bdhabi", "sharjah", "al%2Bain", "ajman"},
	"honduras":           PresetLocations{"honduras", "tegucigalpa", "san%2Bpedro%2Bsula", "choloma", "la%2Bceiba", "el%2Bprogreso", "choluteca", "comayagua"},
	"tajikistan":         PresetLocations{"tajikistan", "dushanbe", "khujand"},
	"papua new guinea":   PresetLocations{"papua%2Bnew%2Bguinea", "port%2Bmoresby", "lae"},
	"serbia":             PresetLocations{"serbia", "belgrade", "novi%2Bsad", "nis", "kragujevac", "subotica", "zrenjanin", "pancevo", "cacak", "novi%2Bpazar", "kraljevo", "smederevo"},
	"switzerland":        PresetLocations{"switzerland", "zurich", "z%C3%Brich", "geneva", "basel", "lausanne", "bern", "winterthur", "lucerne", "gallen", "lugano", "biel", "thun"},
	"togo":               PresetLocations{"togo", "lome"},
	"sierra leone":       PresetLocations{"sierra%2Bleone", "freetown", "makeni", "koidu"},
	"hong kong":          PresetLocations{"hong%2Bkong", "kowloon"}}
