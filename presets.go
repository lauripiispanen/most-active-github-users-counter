...
var PRESETS = map[string]QueryPreset{
	...
	"palestine": include :[]{"abasan%20al-kabira", "abu%20dis","bani%20na'im","bani%20suheila","beit%20hanoun","beit%20jala","beit%20lahia","beit%20sahour","beit%20ummar","beitunia","bethlehem","al-bireh","deir%20al-balah","ad-dhahiriya","dura","gaza","halhul","al-khalil","idhna","jabalia","jenin","ariha","khan%20yunis","nablus","qabatiya","qalqilya","rafah","ramallah","sa'ir","as-samu","surif","tubas","tulkarm","ya'bad","al-yamun","yatta","az-zawayda"
     	},
}
